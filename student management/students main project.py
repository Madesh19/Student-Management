...
def showimage():
    ...
    filename=filedialog.askopenfilename(initialdir=os.getcwd(),
                                        title="select image file",filetyp=(("JPG File","*.jpg"),
                                                                            ("PNG File","*.png"),
                                                                            ("all files","*.txt")))
...
def Clear():
    ...
    img1=PhotoImage(file="upload 3.png")
...
def Save():
    ...
    if N1=="" or C1=="Select Class" or Re1=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
 ...
 #           print(str(name))
  ...
  #          print(reg_no_position)
   #         print(reg_number)
    ...
    img=(Image.open("Students Images/"+str(x1)+".jpg"))
    resized_image=img.resize((190,190))
    photo2=ImageTk.PhotoImage(resized_image)
    lbl.config(image=photo2)
    lbl.image=photo2
...
#top frames
Label(root,text="Email: madeshmadeshwaran472@gmail.com",width=15,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)                     
...
imageicon4=PhotoImage(file="fileup.png")
...
Religion=StringVar()
relegion_entry=Entry(obj,textvariable=Religion,width=20,font="arial 10")
relegion_entry.place(x=630,y=100)
...
Class=Combobox(obj,values=['CS','CT','SS','IT','CA','B&I','A&F','NW'],font="Roboto 10",width=17,state="r")
...
fO_name_entry=Entry(obj2,textvariable=Mother_Occupation,width=20,font="arial 10")
fO_name_entry.place(x=630,y=100)

#image
f=Frame(root,bd=3,bg="black",width=200,height=200,relief=GROOVE)
f.place(x=1000,y=150)

img=PhotoImage(file="upload 3.png")
